...
//Path cost: 370
//
//Measuring shortest path from v(ATL) to v(ORD)
//All destination vertices of v(ATL) are: v(IAD), v(IND), v(IAH)
//v(IND) (d: 122) is the next vertex in our Path. All destination vertices of v(IND) are: v(ATL), v(ORD), v(MKC)
//v(ORD) (d: 167) is the next vertex in our Path. Shortest path found.
//
//Shortest Path from v(ATL) to v(ORD): ATL IND ORD 
//Path cost: 167
//
//Shortest Path from v(ATL) to v(ATL): ATL 
//Path cost: 0
